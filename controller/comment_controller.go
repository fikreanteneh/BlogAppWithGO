...
func (cc *CommentController) CreateComment(c *gin.Context) {
    PostHandler(c, cc.commentUseCase.CreateCommentByBlogID, &model.CommentCreate{}, &model.IdParam{ID: c.Param("blog_id")})
}

func (cc *CommentController) UpdateComment(c *gin.Context) {
    PutHandler(c, cc.commentUseCase.UpdateCommentByID, &model.CommentCreate{}, &model.IdParam{ID: c.Param("comment_id")})
}
